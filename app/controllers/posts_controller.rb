class PostsController < ApplicationController
  ...
  def create
    ...
    if @post.save
      render json: @post, include: {comments: {include: {user:{only: :username}}}}, status: :created, location: @post
  ...
  private
    ...
    def post_params
      params.require(:post).permit(:title, :picture, :content, :user_id, :topic_id)
    end
end
